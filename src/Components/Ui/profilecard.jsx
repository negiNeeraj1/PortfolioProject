        ...
        <AnimatePresence>
          {isRevealed && (
            <motion.div
              ...
              <div className="p-4">
                <h1 className="text-xl font-bold tracking-wider text-black dark:text-white">{name}</h1>
                <p className="text-sm tracking-wider text-gray-600 dark:text-gray-300">{position}</p>
              </div>

              <div className="absolute top-[4rem] left-[8rem]">
                <h3 className="text-lg font-semibold mb-2 text-black dark:text-white">Skills</h3>
              ...
              <div className="absolute top-[13rem] left-0 px-4">
                <p className="text-sm text-black dark:text-white">{bio}</p>
              </div>

              <div className="absolute bottom-4 left-4 flex gap-4">
                {twitterUrl && (
                  <a href={twitterUrl} target="_blank" rel="noreferrer" className="text-black dark:text-white hover:text-blue-500">
                    <Twitter className="h-5 w-5" />
                    <span className="sr-only">Twitter</span>
                  </a>
                )}
                {githubUrl && (
                  <a href={githubUrl} target="_blank" rel="noreferrer" className="text-black dark:text-white hover:text-gray-600">
