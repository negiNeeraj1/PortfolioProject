...
const Projects = () => {
  ...
  const projects = [
   ...
   
    {
      ...
      category: "fullstack",
      liveUrl: "https://yogaweb2-0-frontend2-0.onrender.com/",
      githubUrl: "https://github.com/negiNeeraj1/YogaWeb2.0",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      category: "fullstack",
      liveUrl: "https://github.com/negiNeeraj1/chatApp",
      githubUrl: "https://github.com/negiNeeraj1/chatApp",
    },
    {
      id: 4,
      title: "ecoLearn",
  ...
  {
  id: 6,
  title: "Resume Analyzer & Job Recommendation System",
  description:
    "An AI-powered web application that analyzes resumes, extracts skills, provides ATS-based insights, and recommends suitable job roles using Machine Learning and NLP.",
  image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSs8WxWEMVjnUcWDpHBL0FqQ9YyKtLgS2kc_e_n-HwmBQ&s=10",
  technologies: [
    "Python",
    "Streamlit",
    "MySQL",
  ...
  category: "ai",
  liveUrl: "https://github.com/negiNeeraj1/ResumeAnalyzerRecommendation",
  githubUrl: "https://github.com/negiNeeraj1/ResumeAnalyzerRecommendation"
},
{
  id: 7,
  title: "Study AI",
  description:
    "An AI-powered learning platform that generates personalized study materials, adaptive quizzes, and provides an intelligent chatbot tutor using Google Gemini API.",
  image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQkpKK1L9g--YVMATL94HcwmdHQ-154DZ3TLUz-hVmWwQ&s=10",
  technologies: [
    "React",
    "Node.js",
    "Express.js",
  ...
  category: "ai",
  liveUrl: "https://study-monk-frontend.onrender.com/",
  githubUrl: "https://github.com/negiNeeraj1/ai-powered-study-material"
},
  ];
  ...
  return (
    <section
      id="projects"
      className="py-20 bg-transparent min-h-screen overflow-hidden mt-4"
    >
